...
const EDITABLE_CLASSNAME =
  'inline-block min-h-[1em] min-w-[1ch] cursor-text rounded-sm outline-dashed outline-1 outline-offset-2 outline-accent/50 focus:bg-accent/10 focus:outline-2 focus:outline-accent';
