...
// merely checked after the fact: reordering only ever PERMUTES the nine
...
// Starting from a real, already-valid sections.json (exactly nine unique
// ids, guaranteed by the same guard at build time) means every state this
// component can produce still has exactly those same nine ids, always.
...
// permutes the nine bespoke, component-backed entries. AdminApp.tsx's own
